                    ...
                    >
                        ...
                        <div className="grid grid-cols-1 gap-4 w-full place-items-center
                            ...
                            <div className="w-full h-32 max-w-96 
                                ...
                                >
                                    <div className="flex-1 flex flex-col gap-2 items-center">
                                        <h2 className="flex-1 flex place-items-end text-2xl lg:text-4xl">SOLO</h2>
                                        <p className="flex-1 text-xs text-center md:text-sm">Joue en solo et prouve que tu es le boss de la culture géo !</p>
                                    </div>
                                    <div className="flex w-[30%] h-auto justify-center
                                                    md:w-auto md:h-[40%]">

                                        <div><Button className="">Créer</Button></div>
                                    </div>
                                </Card>
                            </div>
                            <div className="w-full h-32 max-w-96 sm:w-90 sm:h-42 md:w-72 md:h-90 lg:w-80 lg:h-96">
                                ...
                                >
                                    <div className="flex-1 flex flex-col gap-2 items-center">
                                        <h2 className="flex-1 flex place-items-end text-2xl lg:text-4xl">MULTI</h2>
                                        <p className="flex-1 text-xs text-center md:text-sm">Crée ta partie et défie tes potes !</p>
                                    </div>
                                    <div className="flex w-[30%] h-auto justify-center
                                                    md:w-auto md:h-[40%]">
