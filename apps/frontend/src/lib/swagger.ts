  ...
  components: {
    schemas: {
      ...
      Categories: {
        ...
        description:
          "Catégorie de l'objet à deviner, avec plusieurs options disponibles",
      },
      GameStatus: {
        type: 'string',
        enum: ['LOBBY', 'IN_PROGRESS', 'RESULTS', 'FINISHED'],
        description:
          'Statut actuel du jeu, représentant les différentes étapes du jeu',
      },
      RoundStatus: {
        type: 'string',
        enum: ['GUESSING', 'HAS_GUESSED', 'SHOWING_RESULTS'],
        description:
          'Statut actuel du round, représentant les différentes étapes de la phase de supposition',
      },
      Coord: {
        type: 'object',
        properties: {
      ...
      Guess: {
        ...
        properties: {
          ...
          distance: {
            type: 'number',
            description: 'Distance entre la supposition et la cible',
          },
          points: {
            type: 'number',
            description: 'Points attribués pour cette supposition',
          },
          win: {
            type: 'boolean',
            description: 'Indique si la supposition est gagnante',
          },
        },
      ...
      GuessObject: {
        ...
        properties: {
          ...
          image: {
            type: 'string',
            description: "URL de l'image représentant l'objet",
          },
          answer: {
            type: 'object',
            properties: {
              place_name: {
                type: 'string',
                description: 'Nom du lieu correspondant à la réponse',
              },
              coordinates: {
                type: 'object',
                properties: {
                  type: {
                    type: 'string',
                    description: "Type de coordonnées (ex: 'Point')",
                  },
                  value: {
                    type: 'object',
                    description:
                      'Valeur des coordonnées sous un format spécifique',
                  },
                },
                required: ['type', 'value'],
              },
      ...
      Result: {
        ...
        properties: {
          ...
          distance: {
            type: 'number',
            description: 'Distance entre la supposition et la réponse correcte',
          },
          points: {
            type: 'number',
            description: 'Points attribués pour la supposition',
          },
        },
      ...
      Player: {
        ...
        properties: {
          ...
          results: {
            ...
            description:
              'Liste des résultats du joueur pour chaque supposition',
          },
          connected: {
            type: 'boolean',
      ...
      GameConfig: {
        ...
        properties: {
          ...
          nbOfObjects: {
            type: 'integer',
            description: "Nombre d'objets à deviner",
          },
        },
      ...
      Game: {
        ...
        properties: {
          ...
          currentRound: {
            ...
            nullable: true,
            description:
              "Round en cours, peut être null si la partie n'a pas commencé",
          },
        },
      },
      Error: {
