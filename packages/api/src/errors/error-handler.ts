...
const ERROR_MESSAGES: Record<ErrorCode, string> = {
  ...
  [ErrorCode.USER_EMAIL_ALREADY_TAKEN]: "L'adresse mail est déjà utilisée pour un autre compte.",
  ...
  [ErrorCode.USER_REFRESH_FAILED]: 'Session expirée. Veuillez vous reconnecter.',
  ...
  [ErrorCode.GUESS_OBJECTS_GET_FAILED]: 'Erreur lors de la récupération des objets.',
  [ErrorCode.GUESS_OBJECTS_SEARCH_FAILED]: 'Erreur lors de la recherche des objets.',

  // World location
  [ErrorCode.WORLD_LOCATION_SEARCH_FAILED]: 'Erreur lors de la recherche du lieu.',
  ...
  // Email
  [ErrorCode.EMAIL_SEND_FAILED]: "Erreur lors de l'envoi de l'email. Veuillez réessayer.",
